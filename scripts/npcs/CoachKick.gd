## CoachKick.gd
## =============================================================
## Soccer coach who runs the "Goal Kicker" challenge.
##
## Mission: "Goal Kicker"
## Reward:  12 VIBE + 30 XP + Golden Cleats Badge NFT
## =============================================================
extends "res://scripts/npcs/NPC.gd"

const MISSION_ID: String = "soccer_goal_kicker"
...
func _ready() -> void:
	npc_name = "Coach Kick"
	npc_id = "coach_kick"
	sprite_color = Color(0.18, 0.65, 0.30)
...
func _present_puzzle() -> void:
	...
	if hud and hud.has_method("show_challenge"):
		hud.show_challenge("SoccerKickPanel", _mission_data, self)
