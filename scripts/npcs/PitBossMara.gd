## PitBossMara.gd
## =============================================================
## Runs Daisy's dog pit challenge.
## =============================================================
extends "res://scripts/npcs/NPC.gd"

const MISSION_ID: String = "daisy_dog_pit"
...
func _ready() -> void:
	...
	sprite_color = Color(0.72, 0.32, 0.28)
...
func _present_puzzle() -> void:
	...
	if hud and hud.has_method("show_challenge"):
		hud.show_challenge("DaisyDogFightPanel", _mission_data, self)
